...
class HomeViewController: UIViewController {
    ...
    private func configureNavbar() {
        var image = UIImage(named: "Netflix-N-Symbol-logo-red-transparent-RGB-png")
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) { //funckija za to da ka skrolam prema dole se manke gornji navBar
